    ...
    },
    {
      ...
      submenu: [
        ...
        },
        {
          ...
          click() {
            const yiffWindow = new BrowserWindow({width: isWin ? 702 : 700, height: isWin ? 942 : 932, title: "Juno's Ass"});
    ...
    },
    {
      ...
      submenu: [
        ...
        },
        {
          ...
          click() {
            const humansWindow = new BrowserWindow({width: isWin ? 532 : 532, height: isWin ? 638 : 618, title: "humans.txt"});
